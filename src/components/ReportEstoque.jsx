  ...
  return (
    <div className="grid-one-item grid-common grid-c3">
        <div className="grid-c-title">
            <h3 className="grid-c-title-text">Dados de Compras</h3>
                    ...
                    reportData.map((report) => (
                        <div className="grid-chart-bar" key={report.id}>
                            <div className="bar-wrapper">
                                <div className="bar-item1" style={{ height: `${report.value1 !== null ? "10%" : ""}` }}></div>
                                <div className="bar-item2" style={{ height: `${report.value2 !== null ? "80%" : ""}` }}></div>
                            </div>
